    ...
    return (
        <main className="bg-white">
            ...
            {isStaticDeploy && (
                <>
                    {/* DEMO VIDEO */}
                    <section id="demo" className="bg-slate-50 border-y border-slate-100 py-24 px-6">
                        <div className="max-w-5xl mx-auto">
                            <div className="text-center mb-12">
                                ...
                                <h2 className="text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight">
                                    See <span className="text-blue-600">Bridge</span>Board in action
                                </h2>
                                <p className="mt-4 text-lg text-slate-500 max-w-2xl mx-auto">
                                    A full end-to-end Cypress run covering registration, dashboard, MOS translation, job search, and contact management.
                                </p>
                            </div>
                            ...
                            <p className="text-center mt-6 text-sm text-slate-400 font-medium">
                                Cypress E2E demo · 7 test suites · 1.8x playback for narration pacing
                            </p>
                        </div>
                    </section>
                        ...
                        <div className="max-w-7xl mx-auto">
                            ...
                            <div className="grid md:grid-cols-3 gap-8">
                                ...
                                <div className="bg-white border border-slate-100 rounded-2xl shadow-sm p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
                                    ...
                                    <h3 className="text-xl font-extrabold text-slate-900 mb-3">MOS Translator</h3>
                                    <p className="text-slate-500 mb-6 leading-relaxed">
                                        AI-powered translation of any military specialty code into civilian-ready job titles, transferable skills, and ATS keywords.
                                    </p>
                                    <div className="bg-slate-50 rounded-xl p-4 border border-slate-100">
                                        ...
                                        <p className="text-sm font-semibold text-blue-600">→ Operations Manager</p>
                                        <p className="text-sm font-semibold text-blue-600">→ Team Lead</p>
                                        <p className="text-sm font-semibold text-blue-600">→ Security Specialist</p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white border border-slate-100 rounded-2xl shadow-sm p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
                                    ...
                                    <h3 className="text-xl font-extrabold text-slate-900 mb-3">Application Tracker</h3>
                                    <p className="text-slate-500 mb-6 leading-relaxed">
                                        Centralized dashboard for every job application — status, tasks, interview notes, and Adzuna-powered job search built in.
                                    </p>
                                    <div className="bg-slate-50 rounded-xl p-4 border border-slate-100 space-y-2">
                                        <div className="flex items-center justify-between">
                                            <span className="text-sm font-semibold text-slate-700">Lockheed Martin</span>
                                            <span className="text-xs font-bold uppercase px-2 py-0.5 rounded bg-amber-100 text-amber-700">Interviewing</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-sm font-semibold text-slate-700">Anduril</span>
                                            <span className="text-xs font-bold uppercase px-2 py-0.5 rounded bg-blue-100 text-blue-700">Applied</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-sm font-semibold text-slate-700">Palantir</span>
                                            <span className="text-xs font-bold uppercase px-2 py-0.5 rounded bg-emerald-100 text-emerald-700">Offer</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white border border-slate-100 rounded-2xl shadow-sm p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
                                    ...
                                    <h3 className="text-xl font-extrabold text-slate-900 mb-3">Networking Contacts</h3>
                                    <p className="text-slate-500 mb-6 leading-relaxed">
                                        Track every recruiter, mentor, and referral. Notes, companies, and emails — all in one place, never lost in your inbox.
                                    </p>
                                    <div className="bg-slate-50 rounded-xl p-4 border border-slate-100">
                                        <div className="flex items-center gap-3">
                                            <div className="h-10 w-10 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold text-sm">JS</div>
                                            <div>
                                                <p className="text-sm font-bold text-slate-900">Jordan Smith</p>
                                                <p className="text-xs font-semibold text-slate-500">Recruiter · Anduril</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    {/* TECH STACK */}
                    <section id="stack" className="bg-slate-50 border-y border-slate-100 py-24 px-6">
                        <div className="max-w-5xl mx-auto">
                            <div className="text-center mb-16">
                                <span className="inline-block text-xs font-bold uppercase tracking-[0.2em] text-blue-600 bg-blue-100 px-4 py-1.5 rounded-md mb-4">
                                    Engineering
                                ...
                                <p className="mt-4 text-lg text-slate-500 max-w-2xl mx-auto">
                                    Production-grade architecture: containerized services, server-side API key isolation, full E2E test coverage.
                                </p>
                            </div>

                            <div className="grid md:grid-cols-2 gap-6">
                                <StackCard title="Frontend" items={["React 19", "Vite", "React Router DOM", "Tailwind CSS v4", "Axios"]} />
                                <StackCard title="Backend" items={["Django 6", "Django REST Framework", "Token Authentication", "Gunicorn", "PostgreSQL 15"]} />
                                <StackCard title="Infrastructure" items={["Docker Compose", "Nginx (reverse proxy)", "3-container architecture"]} />
                                <StackCard title="Integrations & Testing" items={["Google Gemini 2.5 Flash", "Adzuna Jobs API (server-proxied)", "Jest + React Testing Library", "Cypress E2E (7 suites)"]} />
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="py-20 px-6 bg-white">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-lg text-slate-500 leading-relaxed mb-8">
                                This page is a static showcase deployed to GitHub Pages. The full BridgeBoard application —
                                Django REST API, PostgreSQL, server-side Adzuna and Gemini integrations — runs locally via Docker Compose.
                                See the README for setup, or watch the demo above for a complete end-to-end walkthrough.
                            </p>
...
const StackCard = ({ title, items }) => (
    <div className="bg-white border border-slate-100 rounded-2xl shadow-sm p-8">
        <p className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 mb-4">{title}</p>
